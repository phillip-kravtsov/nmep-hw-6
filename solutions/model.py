...
class TransferModel(object):
    ...
    def build_graph(self):
        ...
        self.train_net, _ = self.train_net(self.inputs)
        self.test_net, _ = self.test_net(self.inputs)
        self.y_hat = tf.cond(self.is_train, lambda: self.train_net, lambda: self.test_net, name="train_cond")
        ...
        self.loss = tf.reduce_mean(
            tf.nn.softmax_cross_entropy_with_logits_v2(
                logits=self.y_hat, labels=self.labels))
            ...
            while True:
                ...
                if batch is None:
                    ...
                    batch_loss, batch_acc, batch_sum = self.sess.run(
                        ...
                        feed_dict=feed_dict)
                    self.val_writer.add_summary(batch_sum, idx)
